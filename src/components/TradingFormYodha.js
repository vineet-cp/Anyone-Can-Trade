        ...
        <div className="flex flex-col gap-6 md:border-r md:border-gray-300 md:pl-8">
          ...
          <div className='flex flex-col items-start'>
            ...
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="profession" className="mr-2" /> Salaried
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="profession" className="mr-2" /> Self employed
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="profession" className="mr-2" /> Not Working
            </label>
          </div>
          ...
          <div className='flex flex-col items-start'>
            ...
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="capital" className="mr-2" /> Less than 50K
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="capital" className="mr-2" /> Less than 1 lakh
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="capital" className="mr-2" /> Above one lakh
            </label>
          </div>
          ...
          <div className='flex flex-col items-start'>
            ...
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="return" className="mr-2" /> To Become a Full-time trader/Career in stock market
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="return" className="mr-2" /> Part time trader
            </label>
            <label className="block ml-4 md:ml-6">
          ...
          <div className='flex flex-col items-start'>
            ...
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="experience" className="mr-2" /> Intraday
            </label>
            <label className="block ml-4 md:ml-6">
         ...
         {/* Q9 */}
          <div className='flex flex-col items-start'>
            ...
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="learn" className="mr-2" /> Less than 2 lakhs
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="learn" className="mr-2" /> 2 to 5 lakhs
            </label>
            <label className="block ml-4 md:ml-6">
              <input type="radio" name="learn" className="mr-2" /> 5 to 10 lakhs
            </label>
            <label className="block ml-4 md:ml-6">
